...
/* BT81X do not support file address smaller than 
   (FontLineStride*FontHeightInPixels - 148), LINE1_ADDR == 0, so skip this*/
#ifndef DEF_BT81X
...
#else
	HAL_CmdBufIn(LINE2_COLOR);
	CoCmd_TEXT(EVE_LCD_WIDTH/2,EVE_LCD_HIGH/4-FONT_2_H/2,FONT_2,OPT_CENTER,&screen_title[1][0]);
#endif
