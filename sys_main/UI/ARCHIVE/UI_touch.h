...
FTVOID touch_show (FTU32 para)
{
    ...
    HAL_CmdBufIn(VERTEX2F(EVE_LCD_WIDTH/4*EVE_PIXEL_UNIT,0));
    HAL_CmdBufIn(VERTEX2F(EVE_LCD_WIDTH/4*EVE_PIXEL_UNIT,EVE_LCD_HIGH/4*EVE_PIXEL_UNIT));
    HAL_CmdBufIn(VERTEX2F(0,EVE_LCD_HIGH/4*EVE_PIXEL_UNIT));
    HAL_CmdBufIn(VERTEX2F(EVE_LCD_WIDTH/4*EVE_PIXEL_UNIT,EVE_LCD_HIGH/4*EVE_PIXEL_UNIT));
	HAL_CmdBufIn(END());
