/* 
 * make all EVE chip register define in one file
 * you would see a little different file
 * with same name in company's sample code
 * you may refer to company's code
 * when anything missing or incorrect in this file
 */

#ifndef _FT_GPU_H_
#define _FT_GPU_H_

#define FT80X_VERSION "1.9.1"
