...
bmpHDR_st bmpHD[BKGND_ICON_GROUP] = {
	{(FTC8 *)PATH_BKGND_8ICON,	ARGB1555,	0,	32,	32},
	{(FTC8 *)PATH_BKGND_STAR,	ARGB1555,	0,	32,	32},
	{(FTC8 *)PATH_BKGND_BALL,	ARGB1555,	0,	32,	32},
	{(FTC8 *)PATH_BKGND_CAR,	ARGB1555,	0,	80, 80},
	{(FTC8 *)PATH_BKGND_FISH,	ARGB1555,	0,	50,	50},
};
