/* 
 * make 80X and 81X reg define in one file
 */
...
#define CTOUCH_MODE_COMPATIBILITY 1 /* single touch */
#define CTOUCH_MODE_EXTENDED      0 /* multi touch */
...
#ifdef DEF_81X
//we would not have VERTEX2II under the FT81X
