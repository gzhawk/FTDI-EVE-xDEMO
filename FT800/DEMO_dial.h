...
BMP_para bmpSetting[BKGND_ICON_GROUP] = {
	{{PATH_BK_ICON,	    L8,	    0,	TRACK_LEN0, 1         },NEAREST,BORDER,REPEAT},
	{{PATH_BK_ICON1,	L8,	    0,	TRACK_LEN1, 1         },NEAREST,BORDER,REPEAT},
	{{PATH_BK_ICON2,	L8,	    0,	1,          TRACK_HIGH2},NEAREST,REPEAT,BORDER},
	{{PATH_BK_ICON3,	L8,	    0,	1,          TRACK_HIGH3},NEAREST,REPEAT,BORDER},
	{{PATH_ARROW_ICON,	ARGB4,	0,	64,         64        },NEAREST,BORDER,BORDER}
};
